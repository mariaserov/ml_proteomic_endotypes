...
#export results
write.csv(results_df, "/rds/general/user/jdc124/projects/hda_24-25/live/TDS/Group09/full_pipeline/4_outcome_association//Results/aortic_aneurysm_results_df.csv", row.names = FALSE)
